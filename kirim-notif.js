  ...
  const message = {
    ...
    webpush: {
      notification: {
        title,
        body,
        icon: 'https://armstrong-sabandar-rtv-scanner.vercel.app/icon-192.png',
        badge: 'https://armstrong-sabandar-rtv-scanner.vercel.app/icon-192.png',
        vibrate: [200, 100, 200],
        tag: tag || 'rtv-notif'
      },
      fcmOptions: {
        link: 'https://armstrong-sabandar-rtv-scanner.vercel.app'
      }
    },
    tokens
  };
